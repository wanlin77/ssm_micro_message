...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background: #e1e9eb;">
		<form action="<%= basePath %>back/list" id="mainForm" method="post">
			<input type="hidden" name="currentPage" id="currentPage" value="${page.currentPage}"/>
			
			<div class="right">
				<div class="current">当前位置：<a href="javascript:void(0)" style="color:#6E6E6E;">内容管理</a> &gt; 内容列表</div>
				<div class="rightCont">
					<p class="g_title fix">内容列表 <a class="btn03" href="${pageContext.request.contextPath}/back/addMessage">新 增</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn03" href="javascript:deleteBatch('<%=basePath%>');">删 除</a></p>
					<table class="tab1">
						<tbody>
							<tr>
							...
							<tbody>
								...
								<c:forEach items="${messageList}" var="message" varStatus="status">
									<tr  <c:if test="${status.index % 2 != 0}">style='background-color:#ECF6EE;'</c:if>>
										...
										<td>
											<a href="javascript:updateOne('<%=basePath %>',${message.id })">修改</a>&nbsp;&nbsp;&nbsp;
