...
<body style="background: #e1e9eb;">
	<form action="<%=basePath%>back/updateSuccess" id="updateForm" method="post">
		...
		<div class="right">
			...
			<div class="rightCont">
				<p class="g_title fix">
					修改内容 <a class="btn03"
						href="javascript:document.getElementById('updateForm').submit()">提交</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
				...
				<div class="zixun fix">
					...
					<table class="tab2" width="100%">
						...
						<tr>
							<td align="right"><input type="submit" value="提交">&nbsp;&nbsp;<a href="javascript:history.go(-1)">退回 </a></td>
						</tr>
					</table>
